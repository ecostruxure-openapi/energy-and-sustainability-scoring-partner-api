...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EcoStruxureEnergySustainabilityScoringPartnerApi.TimeseriesApi();
  });
  ...
  describe('TimeseriesApi', function() {
    describe('listMetrics', function() {
      it('should call listMetrics successfully', function(done) {
        //uncomment below and update the code to test listMetrics
        //instance.listMetrics(function(error) {
