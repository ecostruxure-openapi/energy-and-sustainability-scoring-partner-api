...
export class SiteMetadata {
    ...
    'daysPerWeekWithVisitors'?: number;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "buildingOccupants",
            "baseName": "buildingOccupants",
            "type": "number",
            "format": ""
        },
        {
            "name": "daysPerWeekWithVisitors",
            "baseName": "daysPerWeekWithVisitors",
            "type": "number",
            "format": ""
        },
        {
            "name": "numberOfVisitorsPerDay",
            "baseName": "numberOfVisitorsPerDay",
            "type": "number",
            "format": ""
        },
        {
            "name": "visitDuration",
            "baseName": "visitDuration",
            "type": "number",
            "format": "double"
        },
        {
            "name": "weeklyOperatingHours",
            "baseName": "weeklyOperatingHours",
            "type": "number",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return SiteMetadata.attributeTypeMap;
    }
