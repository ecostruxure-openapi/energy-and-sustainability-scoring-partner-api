...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EcoStruxureEnergySustainabilityScoringPartnerApi.MeterApi();
  });
  ...
  describe('MeterApi', function() {
    describe('listMeters', function() {
      it('should call listMeters successfully', function(done) {
        //uncomment below and update the code to test listMeters
        //instance.listMeters(function(error) {
