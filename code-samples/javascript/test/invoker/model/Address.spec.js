...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EcoStruxureEnergySustainabilityScoringPartnerApi.Address();
  });
  ...
  describe('Address', function() {
    it('should create an instance of Address', function() {
      ...
      //var instance = new EcoStruxureEnergySustainabilityScoringPartnerApi.Address();
      //expect(instance).to.be.a(EcoStruxureEnergySustainabilityScoringPartnerApi.Address);
    });
