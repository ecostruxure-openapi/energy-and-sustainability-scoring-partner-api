 ...
 * @module invoker/model/Site
 * @version 1.0.0
 */
class Site {
    /**
     * Constructs a new <code>Site</code>.
     * @alias module:invoker/model/Site
     */
    constructor() { 
     ...
     * @param {module:invoker/model/Site} obj Optional instance to populate.
     * @return {module:invoker/model/Site} The populated <code>Site</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('metadata')) {
                obj['metadata'] = SiteMetadata.constructFromObject(data['metadata']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['metadata']) { // data not null
          SiteMetadata.validateJSON(data['metadata']);
        }
 ...
 */
Site.prototype['sourceSystemId'] = undefined;

/**
 * @member {module:invoker/model/SiteMetadata} metadata
 */
Site.prototype['metadata'] = undefined;

/**
 * @member {module:invoker/model/Address} postalAddress
 */
Site.prototype['postalAddress'] = undefined;
