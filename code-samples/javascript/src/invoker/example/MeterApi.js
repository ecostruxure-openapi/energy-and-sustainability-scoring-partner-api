...
function getMetersApi(commandArguments) {
  ...
  if(commandArguments.length < 3){
    throwBadRequestMessageForInvalidParams("accessToken".concat(', siteId'));
    return;
  }
  ...
  let api = new EcoStruxureEnergySustainabilityScoringPartnerApi.MeterApi();
