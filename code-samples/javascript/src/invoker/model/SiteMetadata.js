...
/**
 * The SiteMetadata model module.
 * @module invoker/model/SiteMetadata
 * @version 1.0.0
 */
class SiteMetadata {
    /**
     * Constructs a new <code>SiteMetadata</code>.
     * @alias module:invoker/model/SiteMetadata
     */
    constructor() { 
        
        SiteMetadata.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SiteMetadata</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:invoker/model/SiteMetadata} obj Optional instance to populate.
     * @return {module:invoker/model/SiteMetadata} The populated <code>SiteMetadata</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SiteMetadata();

            if (data.hasOwnProperty('grossArea')) {
                obj['grossArea'] = ApiClient.convertToType(data['grossArea'], 'Number');
            }
            if (data.hasOwnProperty('buildingOccupants')) {
                obj['buildingOccupants'] = ApiClient.convertToType(data['buildingOccupants'], 'Number');
            }
            if (data.hasOwnProperty('daysPerWeekWithVisitors')) {
                obj['daysPerWeekWithVisitors'] = ApiClient.convertToType(data['daysPerWeekWithVisitors'], 'Number');
            }
            if (data.hasOwnProperty('numberOfVisitorsPerDay')) {
                obj['numberOfVisitorsPerDay'] = ApiClient.convertToType(data['numberOfVisitorsPerDay'], 'Number');
            }
            if (data.hasOwnProperty('visitDuration')) {
                obj['visitDuration'] = ApiClient.convertToType(data['visitDuration'], 'Number');
            }
            if (data.hasOwnProperty('weeklyOperatingHours')) {
                obj['weeklyOperatingHours'] = ApiClient.convertToType(data['weeklyOperatingHours'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SiteMetadata</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SiteMetadata</code>.
     */
...
/**
 * @member {Number} grossArea
 */
SiteMetadata.prototype['grossArea'] = undefined;

/**
 * @member {Number} buildingOccupants
 */
SiteMetadata.prototype['buildingOccupants'] = undefined;

/**
 * @member {Number} daysPerWeekWithVisitors
 */
SiteMetadata.prototype['daysPerWeekWithVisitors'] = undefined;

/**
 * @member {Number} numberOfVisitorsPerDay
 */
SiteMetadata.prototype['numberOfVisitorsPerDay'] = undefined;

/**
 * @member {Number} visitDuration
 */
SiteMetadata.prototype['visitDuration'] = undefined;

/**
 * @member {Number} weeklyOperatingHours
 */
SiteMetadata.prototype['weeklyOperatingHours'] = undefined;
