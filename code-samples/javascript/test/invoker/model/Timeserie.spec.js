...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EcoStruxureEnergySustainabilityScoringPartnerApi.Timeserie();
  });
  ...
  describe('Timeserie', function() {
    it('should create an instance of Timeserie', function() {
      // uncomment below and update the code to test Timeserie
      //var instance = new EcoStruxureEnergySustainabilityScoringPartnerApi.Timeserie();
      //expect(instance).to.be.a(EcoStruxureEnergySustainabilityScoringPartnerApi.Timeserie);
    });
