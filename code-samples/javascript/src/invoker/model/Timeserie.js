...
const TimeserieValuesInner = require('./TimeserieValuesInner')

/**
 * The Timeserie model module.
 * @module invoker/model/Timeserie
 * @version 1.0.0
 */
class Timeserie {
    /**
     * Constructs a new <code>Timeserie</code>.
     * @alias module:invoker/model/Timeserie
     */
    constructor() { 
        
        Timeserie.initialize(this);
    }
    ...
    /**
     * Constructs a <code>Timeserie</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:invoker/model/Timeserie} obj Optional instance to populate.
     * @return {module:invoker/model/Timeserie} The populated <code>Timeserie</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new Timeserie();

            if (data.hasOwnProperty('key')) {
                obj['key'] = ApiClient.convertToType(data['key'], 'String');
            }
            if (data.hasOwnProperty('values')) {
                obj['values'] = ApiClient.convertToType(data['values'], [TimeserieValuesInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>Timeserie</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>Timeserie</code>.
     */
    static validateJSON(data) {
        ...
        if (data['values']) { // data not null
            ...
            for (const item of data['values']) {
                TimeserieValuesInner.validateJSON(item);
            };
        }
 ...
 * @member {String} key
 */
Timeserie.prototype['key'] = undefined;

/**
 * @member {Array.<module:invoker/model/TimeserieValuesInner>} values
 */
Timeserie.prototype['values'] = undefined;
