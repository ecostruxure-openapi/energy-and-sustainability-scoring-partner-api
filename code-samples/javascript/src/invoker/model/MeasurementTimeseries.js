...
/**
 * The MeasurementTimeseries model module.
 * @module invoker/model/MeasurementTimeseries
 * @version 1.0.0
 */
class MeasurementTimeseries {
    /**
     * Constructs a new <code>MeasurementTimeseries</code>.
     * @alias module:invoker/model/MeasurementTimeseries
     */
    constructor() { 
        
        MeasurementTimeseries.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MeasurementTimeseries</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:invoker/model/MeasurementTimeseries} obj Optional instance to populate.
     * @return {module:invoker/model/MeasurementTimeseries} The populated <code>MeasurementTimeseries</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MeasurementTimeseries();
    ...
    /**
     * Validates the JSON data with respect to <code>MeasurementTimeseries</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MeasurementTimeseries</code>.
     */
 ...
 * @member {String} key
 */
MeasurementTimeseries.prototype['key'] = undefined;




module.exports = { MeasurementTimeseries }
