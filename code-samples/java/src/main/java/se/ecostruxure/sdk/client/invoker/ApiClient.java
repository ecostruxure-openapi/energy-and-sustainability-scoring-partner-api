...
import se.ecostruxure.sdk.client.invoker.auth.OAuth;
...
public class ApiClient extends JavaTimeFormatter {
    ...
    private String basePath = "https://se-exchange-uat-uat.apigee.net/ecostruxure/user/scoring/v1";
    ...
    protected void init() {
        ...
        authentications.put("OAuth2AuthCode-Sandbox", new OAuth());
