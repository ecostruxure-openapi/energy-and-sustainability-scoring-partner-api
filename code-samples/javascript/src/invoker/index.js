...
const ErrorInvalidParamsInner = require('./model/ErrorInvalidParamsInner');
const Measurement = require('./model/Measurement');
const MeasurementTimeseries = require('./model/MeasurementTimeseries');
...
const SiteMetadata = require('./model/SiteMetadata');
const Timeserie = require('./model/Timeserie');
const TimeserieValuesInner = require('./model/TimeserieValuesInner');
const MeterApi = require('./client/MeterApi');
const PerformanceScoreApi = require('./client/PerformanceScoreApi');
const SiteApi = require('./client/SiteApi');
const TimeseriesApi = require('./client/TimeseriesApi');
...
* <pre>
* var EcoStruxureEnergySustainabilityScoringPartnerApi = require('invoker/index'); // See note below*.
* var xxxSvc = new EcoStruxureEnergySustainabilityScoringPartnerApi.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new EcoStruxureEnergySustainabilityScoringPartnerApi.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new EcoStruxureEnergySustainabilityScoringPartnerApi.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new EcoStruxureEnergySustainabilityScoringPartnerApi.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
...
module.exports = {
     ...
     * @property {module:invoker/model/Address}
     */
    Address,

    /**
     * The Coordinates model constructor.
     * @property {module:invoker/model/Coordinates}
     */
    Coordinates,

    /**
     * The Error model constructor.
     * @property {module:invoker/model/Error}
     */
    Error,

    /**
     * The ErrorInvalidParamsInner model constructor.
     * @property {module:invoker/model/ErrorInvalidParamsInner}
     */
    ErrorInvalidParamsInner,

    /**
     * The Measurement model constructor.
     * @property {module:invoker/model/Measurement}
     */
    Measurement,

    /**
     * The MeasurementTimeseries model constructor.
     * @property {module:invoker/model/MeasurementTimeseries}
     */
    MeasurementTimeseries,

    /**
     * The Meter model constructor.
     * @property {module:invoker/model/Meter}
     */
    Meter,

    /**
     * The PerformanceScore model constructor.
     * @property {module:invoker/model/PerformanceScore}
     */
    PerformanceScore,

    /**
     * The ScoringProvider model constructor.
     * @property {module:invoker/model/ScoringProvider}
     */
    ScoringProvider,

    /**
     * The Site model constructor.
     * @property {module:invoker/model/Site}
     */
    Site,

    /**
     * The SiteMetadata model constructor.
     * @property {module:invoker/model/SiteMetadata}
     */
    SiteMetadata,

    /**
     * The Timeserie model constructor.
     * @property {module:invoker/model/Timeserie}
     */
    Timeserie,

    /**
     * The TimeserieValuesInner model constructor.
     * @property {module:invoker/model/TimeserieValuesInner}
     */
    TimeserieValuesInner,

    /**
    * The MeterApi service constructor.
    * @property {module:invoker/client/MeterApi}
    */
    MeterApi,

    /**
    * The PerformanceScoreApi service constructor.
    * @property {module:invoker/client/PerformanceScoreApi}
    */
    PerformanceScoreApi,

    /**
    * The SiteApi service constructor.
    * @property {module:invoker/client/SiteApi}
    */
    SiteApi,

    /**
    * The TimeseriesApi service constructor.
    * @property {module:invoker/client/TimeseriesApi}
    */
    TimeseriesApi
};
