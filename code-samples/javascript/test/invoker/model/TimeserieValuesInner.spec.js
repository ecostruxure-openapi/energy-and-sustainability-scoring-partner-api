...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EcoStruxureEnergySustainabilityScoringPartnerApi.TimeserieValuesInner();
  });
  ...
  describe('TimeserieValuesInner', function() {
    it('should create an instance of TimeserieValuesInner', function() {
      // uncomment below and update the code to test TimeserieValuesInner
      //var instance = new EcoStruxureEnergySustainabilityScoringPartnerApi.TimeserieValuesInner();
      //expect(instance).to.be.a(EcoStruxureEnergySustainabilityScoringPartnerApi.TimeserieValuesInner);
    });
