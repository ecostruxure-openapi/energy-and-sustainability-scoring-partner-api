...
const PerformanceScore = require('../model/PerformanceScore')
const ScoringProvider = require('../model/ScoringProvider')

/**
* PerformanceScore service.
* @module invoker/client/PerformanceScoreApi
* @version 1.0.0
*/
export default class PerformanceScoreApi {

    /**
    * Constructs a new PerformanceScoreApi. 
    * @alias module:invoker/client/PerformanceScoreApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the createPerformanceScores operation.
     * @callback module:invoker/client/PerformanceScoreApi~createPerformanceScoresCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:invoker/model/PerformanceScore>} data The data returned by the service call.
     ...
     * @param {Array.<module:invoker/model/PerformanceScore>} [performanceScore] Performance Score to be created
     * @param {module:invoker/client/PerformanceScoreApi~createPerformanceScoresCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:invoker/model/PerformanceScore>}
     */
    createPerformanceScores(siteId, opts, callback) {
      opts = opts || {};
      let postBody = opts['performanceScore'];
      // verify the required parameter 'siteId' is set
      if (siteId === undefined || siteId === null) {
        throw new Error("Missing the required parameter 'siteId' when calling createPerformanceScores");
      }
      ...
      let returnType = [PerformanceScore];
      return this.apiClient.callApi(
        '/sites/{site-id}/performance-scores', 'POST',
    ...
    /**
     * Callback function to receive the result of the createSiteAssociation operation.
     * @callback module:invoker/client/PerformanceScoreApi~createSiteAssociationCallback
     * @param {String} error Error message, if any.
     * @param {module:invoker/model/ScoringProvider} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} siteId 
     * @param {Object} opts Optional parameters
     * @param {module:invoker/model/ScoringProvider} [scoringProvider] Scoring Provider resource to be created
     * @param {module:invoker/client/PerformanceScoreApi~createSiteAssociationCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:invoker/model/ScoringProvider}
     */
    createSiteAssociation(siteId, opts, callback) {
      opts = opts || {};
      let postBody = opts['scoringProvider'];
      // verify the required parameter 'siteId' is set
      if (siteId === undefined || siteId === null) {
        throw new Error("Missing the required parameter 'siteId' when calling createSiteAssociation");
      }
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = ScoringProvider;
      return this.apiClient.callApi(
        '/sites/{site-id}/scoring-providers', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
    ...
    /**
     * Callback function to receive the result of the listPerformanceScores operation.
     * @callback module:invoker/client/PerformanceScoreApi~listPerformanceScoresCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:invoker/model/PerformanceScore>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} siteId 
     * @param {Object} opts Optional parameters
     * @param {Array.<module:invoker/model/String>} [type] 
     * @param {Array.<module:invoker/model/String>} [category] 
     * @param {module:invoker/client/PerformanceScoreApi~listPerformanceScoresCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:invoker/model/PerformanceScore>}
     */
    listPerformanceScores(siteId, opts, callback) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'siteId' is set
      if (siteId === undefined || siteId === null) {
        throw new Error("Missing the required parameter 'siteId' when calling listPerformanceScores");
      }
      ...
      let returnType = [PerformanceScore];
      return this.apiClient.callApi(
        '/sites/{site-id}/performance-scores', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null, callback
      );
    }
