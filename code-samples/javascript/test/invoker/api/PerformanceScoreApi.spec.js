...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EcoStruxureEnergySustainabilityScoringPartnerApi.PerformanceScoreApi();
  });
  ...
  describe('PerformanceScoreApi', function() {
    describe('createPerformanceScores', function() {
      it('should call createPerformanceScores successfully', function(done) {
        //uncomment below and update the code to test createPerformanceScores
        //instance.createPerformanceScores(function(error) {
    ...
    describe('createSiteAssociation', function() {
      it('should call createSiteAssociation successfully', function(done) {
        //uncomment below and update the code to test createSiteAssociation
        //instance.createSiteAssociation(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('listPerformanceScores', function() {
      it('should call listPerformanceScores successfully', function(done) {
        //uncomment below and update the code to test listPerformanceScores
        //instance.listPerformanceScores(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
