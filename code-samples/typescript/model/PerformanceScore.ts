...
export class PerformanceScore {
    'date': string;
    'score': number;
    'type': PerformanceScoreTypeEnum;
    'category': PerformanceScoreCategoryEnum;
    'updatedAt'?: Date;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "category",
            "baseName": "category",
            "type": "PerformanceScoreCategoryEnum",
            "format": ""
        },
        {
            "name": "updatedAt",
    ...
    static getAttributeTypeMap() {
        return PerformanceScore.attributeTypeMap;
    }
...
export enum PerformanceScoreTypeEnum {
    Daily = 'daily',
    Monthly = 'monthly',
    LocalAverage = 'localAverage',
    Average = 'average'
}
export enum PerformanceScoreCategoryEnum {
    Energy = 'energy',
    Water = 'water',
    Waste = 'waste',
