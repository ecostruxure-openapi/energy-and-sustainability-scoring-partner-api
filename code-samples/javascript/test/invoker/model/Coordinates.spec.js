...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EcoStruxureEnergySustainabilityScoringPartnerApi.Coordinates();
  });
  ...
  describe('Coordinates', function() {
    it('should create an instance of Coordinates', function() {
      ...
      //var instance = new EcoStruxureEnergySustainabilityScoringPartnerApi.Coordinates();
      //expect(instance).to.be.a(EcoStruxureEnergySustainabilityScoringPartnerApi.Coordinates);
    });
