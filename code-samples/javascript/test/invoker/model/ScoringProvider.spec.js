...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EcoStruxureEnergySustainabilityScoringPartnerApi.ScoringProvider();
  });
  ...
  describe('ScoringProvider', function() {
    it('should create an instance of ScoringProvider', function() {
      // uncomment below and update the code to test ScoringProvider
      //var instance = new EcoStruxureEnergySustainabilityScoringPartnerApi.ScoringProvider();
      //expect(instance).to.be.a(EcoStruxureEnergySustainabilityScoringPartnerApi.ScoringProvider);
    });

    it('should have the property leedId (base name: "leedId")', function() {
      // uncomment below and update the code to test the property leedId
      //var instance = new EcoStruxureEnergySustainabilityScoringPartnerApi.ScoringProvider();
      //expect(instance).to.be();
    });

    it('should have the property leedName (base name: "leedName")', function() {
      // uncomment below and update the code to test the property leedName
      //var instance = new EcoStruxureEnergySustainabilityScoringPartnerApi.ScoringProvider();
      //expect(instance).to.be();
    });
