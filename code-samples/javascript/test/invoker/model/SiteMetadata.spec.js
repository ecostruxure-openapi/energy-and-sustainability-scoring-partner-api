...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EcoStruxureEnergySustainabilityScoringPartnerApi.SiteMetadata();
  });
  ...
  describe('SiteMetadata', function() {
    it('should create an instance of SiteMetadata', function() {
      // uncomment below and update the code to test SiteMetadata
      //var instance = new EcoStruxureEnergySustainabilityScoringPartnerApi.SiteMetadata();
      //expect(instance).to.be.a(EcoStruxureEnergySustainabilityScoringPartnerApi.SiteMetadata);
    });

    it('should have the property grossArea (base name: "grossArea")', function() {
      // uncomment below and update the code to test the property grossArea
      //var instance = new EcoStruxureEnergySustainabilityScoringPartnerApi.SiteMetadata();
      //expect(instance).to.be();
    });

    it('should have the property buildingOccupants (base name: "buildingOccupants")', function() {
      // uncomment below and update the code to test the property buildingOccupants
      //var instance = new EcoStruxureEnergySustainabilityScoringPartnerApi.SiteMetadata();
      //expect(instance).to.be();
    });

    it('should have the property daysPerWeekWithVisitors (base name: "daysPerWeekWithVisitors")', function() {
      // uncomment below and update the code to test the property daysPerWeekWithVisitors
      //var instance = new EcoStruxureEnergySustainabilityScoringPartnerApi.SiteMetadata();
      //expect(instance).to.be();
    });

    it('should have the property numberOfVisitorsPerDay (base name: "numberOfVisitorsPerDay")', function() {
      // uncomment below and update the code to test the property numberOfVisitorsPerDay
      //var instance = new EcoStruxureEnergySustainabilityScoringPartnerApi.SiteMetadata();
      //expect(instance).to.be();
    });

    it('should have the property visitDuration (base name: "visitDuration")', function() {
      // uncomment below and update the code to test the property visitDuration
      //var instance = new EcoStruxureEnergySustainabilityScoringPartnerApi.SiteMetadata();
      //expect(instance).to.be();
    });

    it('should have the property weeklyOperatingHours (base name: "weeklyOperatingHours")', function() {
      // uncomment below and update the code to test the property weeklyOperatingHours
      //var instance = new EcoStruxureEnergySustainabilityScoringPartnerApi.SiteMetadata();
      //expect(instance).to.be();
    });
