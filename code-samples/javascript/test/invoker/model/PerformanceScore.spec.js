...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EcoStruxureEnergySustainabilityScoringPartnerApi.PerformanceScore();
  });
  ...
  describe('PerformanceScore', function() {
    it('should create an instance of PerformanceScore', function() {
      // uncomment below and update the code to test PerformanceScore
      //var instance = new EcoStruxureEnergySustainabilityScoringPartnerApi.PerformanceScore();
      //expect(instance).to.be.a(EcoStruxureEnergySustainabilityScoringPartnerApi.PerformanceScore);
    });
