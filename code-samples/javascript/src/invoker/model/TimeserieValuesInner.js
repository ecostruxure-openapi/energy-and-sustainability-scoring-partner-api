...
/**
 * The TimeserieValuesInner model module.
 * @module invoker/model/TimeserieValuesInner
 * @version 1.0.0
 */
class TimeserieValuesInner {
    /**
     * Constructs a new <code>TimeserieValuesInner</code>.
     * @alias module:invoker/model/TimeserieValuesInner
     */
    constructor() { 
        
        TimeserieValuesInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TimeserieValuesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:invoker/model/TimeserieValuesInner} obj Optional instance to populate.
     * @return {module:invoker/model/TimeserieValuesInner} The populated <code>TimeserieValuesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TimeserieValuesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>TimeserieValuesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TimeserieValuesInner</code>.
     */
 ...
 * @member {Date} date
 */
TimeserieValuesInner.prototype['date'] = undefined;

/**
 * @member {Date} updatedAt
 */
TimeserieValuesInner.prototype['updatedAt'] = undefined;

/**
 * @member {Number} value
 */
TimeserieValuesInner.prototype['value'] = undefined;




module.exports = { TimeserieValuesInner }
