...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EcoStruxureEnergySustainabilityScoringPartnerApi.ErrorInvalidParamsInner();
  });
  ...
  describe('ErrorInvalidParamsInner', function() {
    it('should create an instance of ErrorInvalidParamsInner', function() {
      // uncomment below and update the code to test ErrorInvalidParamsInner
      //var instance = new EcoStruxureEnergySustainabilityScoringPartnerApi.ErrorInvalidParamsInner();
      //expect(instance).to.be.a(EcoStruxureEnergySustainabilityScoringPartnerApi.ErrorInvalidParamsInner);
    });
