...
/**
* Meter service.
* @module invoker/client/MeterApi
* @version 1.0.0
*/
export default class MeterApi {

    /**
    * Constructs a new MeterApi. 
    * @alias module:invoker/client/MeterApi
    * @class
    ...
    */
    ...
    /**
     * Callback function to receive the result of the listMeters operation.
     * @callback module:invoker/client/MeterApi~listMetersCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:invoker/model/Meter>} data The data returned by the service call.
     ...
     * @param {String} siteId 
     * @param {module:invoker/client/MeterApi~listMetersCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:invoker/model/Meter>}
     */
    listMeters(siteId, callback) {
      let postBody = null;
      // verify the required parameter 'siteId' is set
      if (siteId === undefined || siteId === null) {
        throw new Error("Missing the required parameter 'siteId' when calling listMeters");
      }
