...
/**
 * The ScoringProvider model module.
 * @module invoker/model/ScoringProvider
 * @version 1.0.0
 */
class ScoringProvider {
    /**
     * Constructs a new <code>ScoringProvider</code>.
     * @alias module:invoker/model/ScoringProvider
     * @param leedId {Number} 
     * @param leedName {String} 
     */
    constructor(leedId, leedName) { 
        
        ScoringProvider.initialize(this, leedId, leedName);
    }
     ...
     */
    static initialize(obj, leedId, leedName) { 
        obj['leedId'] = leedId;
        obj['leedName'] = leedName;
    }

    /**
     * Constructs a <code>ScoringProvider</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:invoker/model/ScoringProvider} obj Optional instance to populate.
     * @return {module:invoker/model/ScoringProvider} The populated <code>ScoringProvider</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ScoringProvider();

            if (data.hasOwnProperty('leedId')) {
                obj['leedId'] = ApiClient.convertToType(data['leedId'], 'Number');
            }
            if (data.hasOwnProperty('leedName')) {
                obj['leedName'] = ApiClient.convertToType(data['leedName'], 'String');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ScoringProvider</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScoringProvider</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ScoringProvider.RequiredProperties) {
            if (!data.hasOwnProperty(property)) {
                throw new Error("The required field `" + property + "` is not found in the JSON data: " + JSON.stringify(data));
            }
        }
        // ensure the json data is a string
        if (data['leedName'] && !(typeof data['leedName'] === 'string' || data['leedName'] instanceof String)) {
            throw new Error("Expected the field `leedName` to be a primitive type in the JSON string but got " + data['leedName']);
        }
...
ScoringProvider.RequiredProperties = ["leedId", "leedName"];

/**
 * @member {Number} leedId
 */
ScoringProvider.prototype['leedId'] = undefined;

/**
 * @member {String} leedName
 */
ScoringProvider.prototype['leedName'] = undefined;



module.exports = { ScoringProvider }
