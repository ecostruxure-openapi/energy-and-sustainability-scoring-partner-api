...
/**
 * The ErrorInvalidParamsInner model module.
 * @module invoker/model/ErrorInvalidParamsInner
 * @version 1.0.0
 */
class ErrorInvalidParamsInner {
    /**
     * Constructs a new <code>ErrorInvalidParamsInner</code>.
     * The validation error descriptor.
     * @alias module:invoker/model/ErrorInvalidParamsInner
     * @param path {String} 
     * @param name {String} 
     * @param reason {String} 
     */
    constructor(path, name, reason) { 
        
        ErrorInvalidParamsInner.initialize(this, path, name, reason);
    }
     ...
     */
    static initialize(obj, path, name, reason) { 
        obj['path'] = path;
        obj['name'] = name;
        obj['reason'] = reason;
    }
    ...
    /**
     * Constructs a <code>ErrorInvalidParamsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:invoker/model/ErrorInvalidParamsInner} obj Optional instance to populate.
     * @return {module:invoker/model/ErrorInvalidParamsInner} The populated <code>ErrorInvalidParamsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ErrorInvalidParamsInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ErrorInvalidParamsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ErrorInvalidParamsInner</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ErrorInvalidParamsInner.RequiredProperties) {
...
ErrorInvalidParamsInner.RequiredProperties = ["path", "name", "reason"];

/**
 * @member {String} path
 */
ErrorInvalidParamsInner.prototype['path'] = undefined;

/**
 * @member {String} name
 */
ErrorInvalidParamsInner.prototype['name'] = undefined;

/**
 * @member {String} reason
 */
ErrorInvalidParamsInner.prototype['reason'] = undefined;


module.exports = { ErrorInvalidParamsInner }
