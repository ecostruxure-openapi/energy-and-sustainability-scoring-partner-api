...
export default class SiteApi {
    ...
    * @alias module:invoker/client/SiteApi
    * @class
    ...
    */
     ...
     * @callback module:invoker/client/SiteApi~listSitesCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:invoker/model/Site>} data The data returned by the service call.
     ...
     * @param {module:invoker/client/SiteApi~listSitesCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:invoker/model/Site>}
     */
    listSites(callback) {
      let postBody = null;
