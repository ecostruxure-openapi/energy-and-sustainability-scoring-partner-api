...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EcoStruxureEnergySustainabilityScoringPartnerApi.Measurement();
  });
  ...
  describe('Measurement', function() {
    it('should create an instance of Measurement', function() {
      ...
      //var instance = new EcoStruxureEnergySustainabilityScoringPartnerApi.Measurement();
      //expect(instance).to.be.a(EcoStruxureEnergySustainabilityScoringPartnerApi.Measurement);
    });
