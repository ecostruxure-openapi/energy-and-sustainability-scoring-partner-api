...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EcoStruxureEnergySustainabilityScoringPartnerApi.Meter();
  });
  ...
  describe('Meter', function() {
    it('should create an instance of Meter', function() {
      // uncomment below and update the code to test Meter
      //var instance = new EcoStruxureEnergySustainabilityScoringPartnerApi.Meter();
      //expect(instance).to.be.a(EcoStruxureEnergySustainabilityScoringPartnerApi.Meter);
    });
    ...
    it('should have the property commodity (base name: "commodity")', function() {
      // uncomment below and update the code to test the property commodity
      //var instance = new EcoStruxureEnergySustainabilityScoringPartnerApi.Meter();
      //expect(instance).to.be();
    });
